...
<template>
    ...
    <div class="mobile d-lg-none">
        <!-- sign-in -->
        <div class="mobile-sign-in mobile-container">
            <h5 class="text-center">Do you already have an acount?</h5>
            <h1 class="text-center">Sign in</h1>

            <form @submit.prevent="authStore.loginUser(formLogin)">

                <div class="social-container m-0">
                    <a href="" class="social">
                        <svg fill="#faf9f5" height="18px" width="18px" version="1.1" id="Layer_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            viewBox="0 0 310 310" xml:space="preserve" transform="rotate(0)matrix(1, 0, 0, 1, 0, 0)"
        ...
        <div class="mobile-container">
            <form @submit.prevent="authStore.registerUser(formRegister)">
                <h5 class="text-center mb-4">Are you not in the spooky Club?</h5>
                <h1 class="my_create-account" data-bs-toggle="collapse"><a class="create-account m-0"
...
.my_create-account:hover {
    background-color: rgb(246, 212, 44);
}

.my_create-account:active {
    background-color: $secYellow;
}
