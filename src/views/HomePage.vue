            ...
            <div class="container">
                <div class="row">
                    <div class="jumbo-img col-12 col-md-6 pt-4">
                        <img src="../assets/mascotte/ghost-jumbo-hd.png" alt="deliveboo mscotte eating a hamburger"
                            draggable="false">
                    </div>
                    ...
                    <div class="col-12">
                        <div class="row justify-content-center align-items-stretch">
                            <div class="col-12 col-sm-10 col-md-6 col-lg-3 p-2 card_container">
                                <div class="partner-card d-flex flex-column">
                                    <div class="card_image">
                                        <img class="img-fluid" src="../assets/jumbo/rider_jumbo.png"
                                            alt="deliveboo rider image" draggable="false">
                                    </div>
                                    <div class="card_text d-flex flex-column justify-content-between">
                                        <h4>Ghastly Riders</h4>
                                        <p class="m-0">Embark on a haunting journey with our spectral rider team! Join us
                            ...
                            <div class="col-12 col-sm-10 col-md-6 col-lg-3 p-2 card_container">
                                <div class="partner-card d-flex flex-column">
                                    <div class="card_image">
                                        <img class="img-fluid" src="../assets/jumbo/restaurant_jumbo.jpg"
                                            alt="haunted restaurant image" draggable="false">
                                    </div>
                                    <div class="card_text d-flex flex-column justify-content-between">
                                        <h4>Haunted Restaurants</h4>
                                        <p class="m-0">Summon more hungry spirits to your establishment! Partner with us and
                            ...
                            <div class="col-12 col-sm-10 col-md-6 col-lg-3 p-2 card_container">
                                <div class="partner-card d-flex flex-column">
                                    <div class="card_image">
                                        <img class="img-fluid" src="../assets/jumbo/work_with_us_jumbo.jpg"
                                            alt="skeleton employee" draggable="false">
                                    </div>
                                    <div class="card_text d-flex flex-column justify-content-between">
                                        <h4>Join Our Coven</h4>
                                        <p class="m-0">Dive into the shadows and discover eerie career opportunities with
