                            ...
                            <form @submit.prevent="updateDish(this.authStore)" enctype="multipart/form-data">
                                ...
                                <div class="row mb-2">
                                    <div class="col-12 col-md-6 form-section">
                                        ...
                                        <select name="category" id="category" @change="this.formData.category = $event.target.value">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6  form-section">
                                        <label :class="this.errorMessages.photo.visibility ? ' border-error' : 'border-none'"
                                            ...
                                            <input class="w-100" type="file" id="photo" name="photo" @change="this.formData.photo = $event.target.files">
    ...
    methods: {
        ...
        checkValidation() {
            ...
            if (typeof (this.formData.photo) === 'object' || this.formData.photo === null) {
                ...
                this.formDataValidate.photo = false;
            }
            ...
            if (this.formDataValidate.name &&
                ...
                this.formDataValidate.category &&
    ...
    setup() {
        ...
        const getDish = async (id) => {
            try {
                ...
                formData.category = store.editingDish.category_id;
